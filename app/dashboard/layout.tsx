      ...
      >
        <div className="flex h-full flex-col overflow-hidden">
          ...
          <div className="border-b border-border bg-gradient-to-br from-[#1897C6]/5 to-[#F1AF37]/5 p-5">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold truncate">Demo Institute</p>
                <p className="text-xs text-muted-foreground truncate">Code: VIDHKEND123</p>
              </div>
            </div>
          </div>
          ...
          <nav className="flex-1 overflow-y-auto py-4 px-4 space-y-1">
            ...
            {/* Teachers Accordion */}
            {mounted && <Collapsible open={teachersOpen} onOpenChange={setTeachersOpen}>
            ...
            {/* Students Accordion */}
            {mounted && <Collapsible open={studentsOpen} onOpenChange={setStudentsOpen}>
              <CollapsibleTrigger className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-foreground hover:bg-muted transition-all">
